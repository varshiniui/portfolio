...
const projects: Project[] = [
  {
    ...
    icon: Brain,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 290 / 0.72), oklch(0.90 0.08 300 / 0.50), oklch(0.96 0.02 280 / 0.30))",
  ...
  },
  {
    ...
    icon: Mic,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 160 / 0.72), oklch(0.90 0.08 165 / 0.50), oklch(0.96 0.02 155 / 0.30))",
    borderColor: "oklch(0.70 0.10 160 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    icon: MessageSquare,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 180 / 0.72), oklch(0.90 0.07 185 / 0.50), oklch(0.96 0.02 175 / 0.30))",
    borderColor: "oklch(0.70 0.09 180 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    icon: MessageSquare,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 250 / 0.72), oklch(0.90 0.08 255 / 0.50), oklch(0.96 0.02 245 / 0.30))",
    borderColor: "oklch(0.72 0.11 250 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 130 / 0.72), oklch(0.90 0.08 135 / 0.50), oklch(0.96 0.02 125 / 0.30))",
    borderColor: "oklch(0.68 0.10 130 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    icon: NotebookPen,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.05 290 / 0.72), oklch(0.90 0.09 295 / 0.50), oklch(0.96 0.03 285 / 0.30))",
    borderColor: "oklch(0.75 0.13 290 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    icon: Chrome,
    cardGrad: "linear-gradient(135deg, oklch(0.95 0.05 40 / 0.72), oklch(0.91 0.08 38 / 0.50), oklch(0.96 0.03 42 / 0.30))",
    borderColor: "oklch(0.72 0.12 40 / 0.25)",
    accent: {
  ...
  },
  {
    ...
    icon: BarChart3,
    cardGrad: "linear-gradient(135deg, oklch(0.94 0.04 220 / 0.72), oklch(0.90 0.08 225 / 0.50), oklch(0.96 0.02 215 / 0.30))",
    borderColor: "oklch(0.70 0.11 220 / 0.25)",
    accent: {
...
function TechPill({ tech, accentBg, accentColor }: TechPillProps) {
  return (
    <span
              ...
              <div className="p-6 border-t border-border/50 flex items-center gap-4">
                ...
                {project.demoUrl !== "#" && (
                  <a
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${accent.color}, oklch(0.44 0.20 310))`,
...
function FeaturedProjectDemo({ project }: { project: Project }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "oklch(0.97 0.02 290 / 0.60)",
        backdropFilter: "blur(20px)",
        WebkitBackdropFilter: "blur(20px)",
        border: "1px solid oklch(0.80 0.12 290 / 0.30)",
        boxShadow: "0 8px 40px oklch(0.55 0.18 290 / 0.12), inset 0 1px 0 oklch(1 0 0 / 0.60)",
      }}
    >
      ...
      <div className="relative m-[1px] rounded-3xl overflow-hidden"
        style={{
          background: "oklch(0.98 0.01 290 / 0.85)",
          ...
          {otherProjects.map((project, index) => {
            ...
            return (
              <motion.div
                ...
                style={{
                  background: project.cardGrad,
                  backdropFilter: "blur(16px)",
                  WebkitBackdropFilter: "blur(16px)",
                  border: `1px solid ${project.borderColor}`,
                  boxShadow: `0 4px 24px ${project.borderColor}, inset 0 1px 0 oklch(1 0 0 / 0.50)`,
                }}
                ...
                whileHover={{
                  y: -10,
                  scale: 1.025,
                  boxShadow: `0 12px 40px ${project.borderColor}, inset 0 1px 0 oklch(1 0 0 / 0.60)`,
                }}
                onClick={() => openProjectModal(project)}
              >
                <span className="absolute top-4 right-4 px-2 py-1 text-xs font-medium text-muted-foreground bg-white/40 backdrop-blur-sm rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                  Click to preview
                </span>
                ...
                <div className="relative p-6 lg:p-8">
                  <div className="flex items-start gap-4 mb-4">
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${accent.color.replace(")", " / 0.20)")}`,
                      }}
                    >
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    ...
                    {project.techStack.length > 4 && (
                      <span className="px-3 py-1.5 text-xs font-medium bg-white/40 backdrop-blur-sm text-muted-foreground rounded-full">
